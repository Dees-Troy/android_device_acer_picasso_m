...
TARGET_BOARD_INFO_FILE := device/acer/picasso_m/board-info.txt
...
#BOARD_FORCE_RAMDISK_ADDRESS := 0x01002048

BOARD_USES_GENERIC_AUDIO := false
BOARD_PREBUILT_LIBAUDIO := true
BOARD_USES_AUDIO_LEGACY := true

BOARD_EGL_CFG := device/acer/picasso_m/egl.cfg
TARGET_OTA_ASSERT_DEVICE := picasso_m
